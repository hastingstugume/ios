...
export default function DashboardPage() {
  ...
  const outcomeSteps = outcomeTargets
    ? [
      ...
      {
        id: 'pipeline',
        label: `Move ${outcomeTargets.workflow} leads into pipeline`,
  ...
  return (
    <div className="page-shell animate-fade-in">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Link href="/leads" className="inline-flex w-full items-center justify-center gap-1.5 rounded-lg bg-primary px-3 py-2 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90 sm:w-auto">
      ...
      <div className="bg-card border border-border rounded-xl">
        <div className="flex flex-col gap-2 border-b border-border px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-semibold text-foreground">Recent High-Fit Leads</h2>
          </div>
          <Link href="/leads?minConfidence=80" className="text-xs text-primary hover:underline flex items-center gap-1">
